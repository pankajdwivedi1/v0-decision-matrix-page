...
export default function WSMFormula() {
    const latex = {
        ...
        step2_wsm: "Score_i = \\sum_{j=1}^{n} \\overline{x}_{ij} \\cdot w_j \\tag{4}",
    ...
    return (
        ...
        `
            ...
            <div ref={containerRef} className="prose max-w-none bg-white border border-gray-200 rounded-lg p-3 md:p-6 text-justify font-['Times_New_Roman',_Times,_serif] leading-relaxed">
                <h1 className="text-2xl font-bold text-center mb-6">Weighted Sum Model (WSM)</h1>

                <p className="mb-4">
                    The Weighted Sum Model (WSM) is one of the most commonly used MCDM methods. It evaluates a set of alternatives based on multiple criteria by calculating a weighted sum of normalized scores.
                </p>
                ...
                <h2 className="text-xl font-semibold mt-6 mb-2">Step 3. Weighted Sum</h2>
                <p className="mb-2">Calculate the weighted sum score for each alternative:</p>
                <div className="bg-gray-50 rounded-lg mb-4">
                    <div className="latex text-sm text-center" dangerouslySetInnerHTML={{ __html: `\\[${latex.step2_wsm}\\]` }} />
                </div>
                ...
                <div className="mt-8 text-xs text-gray-500 border-t pt-4">
                    Proponent: Fishburn (1967) / Miller & Starr (1969).
                </div>
            </div>
        </>
    )
