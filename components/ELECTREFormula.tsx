...
export default function ELECTREFormula({ compact = false }: ELECTREFormulaProps) {
  ...
  const latex = {
    ...
    interpretation:
      "\\textbf{Interpretation:} \\quad \\text{ELECTRE evaluates alternatives by measuring concordance (agreement) and discordance (disagreement) between pairs. An alternative outranks another if it has sufficient weighted support (concordance) and limited opposition (discordance).}",
  };
      ...
      >
        ...
        <div className="mb-4 bg-blue-50 border border-blue-200 rounded-lg p-3">
          <p className="text-sm text-gray-700 leading-relaxed" style={{ fontSize: "0.875rem" }}>
            ELECTRE evaluates alternatives by building outranking relations based on concordance and discordance indices. An alternative outranks another if it has sufficient concordance and limited discordance.
          </p>
        </div>
        ...
        <ol className="space-y-4 list-decimal pl-5">
          ...
          <li>
            <div className="mb-2 font-semibold">
              Outranking Relation: Build outranking relation based on concordance and discordance thresholds.
            </div>
            <div className="bg-gray-50 rounded-lg mb-4">
              <div
        ...
        <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <p className="text-sm text-gray-700 leading-relaxed" style={{ fontSize: "0.875rem" }}>
            ELECTRE evaluates alternatives by measuring concordance (agreement) and discordance (disagreement) between pairs. An alternative outranks another if it has sufficient weighted support (concordance) and limited opposition (discordance).
          </p>
        </div>

        <div className="mt-4 text-xs text-gray-500">
          Source: ELECTRE method formulation (Roy, 1968). The method evaluates alternatives by building
          outranking relations based on concordance (agreement) and discordance (disagreement) indices.
          An alternative outranks another if it has sufficient weighted support and limited opposition.
        </div>
      </div>
    </>
  );
