...
export default function SWEIFormula({ compact = false, landingPage = false, language = "EN" }: SWEIFormulaProps) {
                ...
                {landingPage ? (
                    <div className="py-4 font-serif">
                        <div className="flex flex-col items-center mb-4 sm:mb-8">
                            <span className="text-[10px] uppercase tracking-[0.3em] font-black text-slate-400 mb-2">Equation Analysis</span>
                            <h1 className="text-xl md:text-2xl font-bold text-center text-slate-900 m-0">
                                {t.sweiTitle}
                            </h1>
                        </div>

                        <div className="border-y border-slate-900 py-6 sm:py-10 my-4 sm:my-8 space-y-4 sm:space-y-8 overflow-x-auto bg-slate-50/30">
                        ...
                        <div className="mt-8 sm:mt-12 pt-4 sm:pt-6 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4">
                            ...
                            <span className="text-[8px] sm:text-[9px] font-bold text-blue-600/50 uppercase tracking-widest text-center sm:text-right">DOI: 10.1016/j.rser.2025.115791</span>
                        </div>
                    </div>
                ) : (
                    <>
