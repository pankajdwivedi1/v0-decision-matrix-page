...
export default function CRITICFormula() {
  const latex = {
    ...
    step3_std: "\\sigma_j = \\sqrt{\\frac{1}{m} \\sum_{i=1}^{m} (r_{i,j} - \\bar{r}_j)^2}",
    step4_corr: "\\rho_{j,k} = \\frac{\\text{Cov}(r_j, r_k)}{\\sigma_j \\sigma_k}",
    step5_info: "C_j = \\sigma_j \\sum_{k=1}^{n} (1 - \\rho_{j,k})",
    step6_weight: "w_j = \\frac{C_j}{\\sum_{j=1}^{n} C_j}, \\quad \\sum_{j=1}^{n} w_j = 1"
  }
  ...
  return (
    <>
      ...
      <div style={{ overflowWrap: "break-word", wordBreak: "break-word" }} className="prose max-w-none bg-white border border-gray-200 rounded-lg p-3 md:p-6 text-justify font-['Times_New_Roman',_Times,_serif] leading-relaxed">
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-4 overflow-x-auto">
          <p className="text-center">{`$$ ${latex.step3_std} $$`}</p>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-4 overflow-x-auto">
          <p className="text-center">{`$$ ${latex.step4_corr} $$`}</p>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-4 overflow-x-auto">
          <p className="text-center">{`$$ ${latex.step5_info} $$`}</p>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-4 overflow-x-auto">
          <p className="text-center">{`$$ ${latex.step6_weight} $$`}</p>
        </div>
