...
def standardize_page():
    ...
    def replacer(match):
        ...
        # Correctly ordered overrides
        if 'normalized_decision_matrix' in asset_key or 'normalization' in asset_key:
            asset_key = f"{method}_normalized_matrix"
        elif 'decision_matrix' in asset_key:
    ...
    with open('app/application/page.tsx', 'w', encoding='utf-8') as f:
        f.write(new_content)
    print("Final global standardization complete (V2).")
